    ...
    fetch(`/daily/api/glacier_daily`)
        ...
        .then(data => {
            ...
            Object.keys(data).forEach(key => {
                ...
                // Check if the value is empty and add message to the corresponding div
                if (data[key].trim() === '' && document.getElementById(key)) {
                    document.getElementById(key).innerHTML = "Section unavailable.";
                }
            });
        })
