...
def get_flickr() -> FlickrImage:
    ...
    try:
        ...
        flickr = FlickrAPI(env_vars['flickr_key'], env_vars['flickr_secret'], format='parsed-json')
        ...
        photos = flickr.photos.search(user_id=environ['glaciernps_uid'], per_page='1', page=potd_num)
