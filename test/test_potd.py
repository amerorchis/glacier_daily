...
def mock_image_response():
    ...
    return {
        'data': [{
            'url_standard': 'https://example.com/test.jpg'
        }]
    }
...
class TestGetProduct:
    ...
    def test_get_product_success(self, mock_product_response, mock_image_response, mock_env_vars):
    ...
    def test_get_product_cached(self):
        ...
        cached_data = ('Test Product', 'https://example.com/img.jpg', 
                      'https://shop.glacier.org/test', 'Cached description')
        
        with patch('product_otd.product.retrieve_from_json', return_value=(True, cached_data)):
            title, image_url, product_link, desc = get_product()
